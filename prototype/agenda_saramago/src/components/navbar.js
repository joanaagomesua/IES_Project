...
export default function Navbar() {const [navbar, setNavbar] = useState(false);}
return (
    <header class="bg-white">
    <div class="container mx-auto px-4 py-8 flex items-center">

    <div class="mr-auto md:w-48 flex-shrink-0">
      <img class="h-8 md:h-10" src="/assets/images/28cd4c1df9f8197c8e1c9b3edf640ee2-caderno-agenda-caderno-caderno-plana.png" alt="">
        <span class="sr-only">Agenda Saramago</span>
      </img>
    </div>
    ...
    <div class="w-full max-w-xs xl:max-w-lg 2xl:max-w-2xl bg-gray-100 rounded-md hidden xl:flex items-center">
      ...
      <input class="border-l border-gray-300 bg-transparent font-semibold text-sm pl-4" type="text" placeholder="I'm searching for ..."></input>
